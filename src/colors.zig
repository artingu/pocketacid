...
pub const bg = RGB.init(30, 48, 28);
pub const inactive = Attrib{ .fg = RGB.init(97, 161, 87), .bg = bg };
pub const playing = Attrib{ .fg = RGB.init(255, 255, 255), .bg = bg };
pub const normal = Attrib{ .fg = RGB.init(161, 148, 87), .bg = bg };
pub const hilight = Attrib{ .fg = RGB.init(161, 109, 87), .bg = bg };
